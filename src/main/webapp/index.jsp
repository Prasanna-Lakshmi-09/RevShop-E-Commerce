        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    ...
                    <li><img class="img-responsive" src="images/a.jpg" height="1000" width="1000"  /></li>
                    <li><img class="img-responsive" src="images/b.png" height="1000" width="1000"/></li>
                    <li><img class="img-responsive" src="images/c.jpg" height="1000" width="1000"/></li>
                    <li><img class="img-responsive" src="images/shoes.jpg" height="1000" width="1000"/></li>
                    <li><img class="img-responsive" src="images/spd.jpg" height="1000" width="1000"/></li>
                </ul>
         <!--  <div class="script-wrap">
                    <ul class="script-group">
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/bpd.jpg" height="500" width="500" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/spd.jpg" height="500" width="500" alt="Dummy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/b.jpeg" height="500" width="500" alt="Dummy Image" />
                            </div></li>
                    </ul>
